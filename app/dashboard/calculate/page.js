  ...
  const handleSubmit = async (e) => {
    ...
    if (user) {
      try {
        ...
        // Przekierowanie do panelu po udanej aktualizacji
        setTimeout(() => {
    ...
    <div className="bg-white rounded-lg p-6 shadow-lg max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-gray-700">Wzrost (cm)</label>
            <input
              type="number"
              name="growth"
          ...
          <div>
            <label className="block text-gray-700">Poziom aktywności</label>
            <select
              name="activity"
            ...
            >
              ...
              <option value="1.375">Lekko aktywny (ćwiczenia 1-3 razy/tydzień)</option>
              <option value="1.55">Umiarkowanie aktywny (ćwiczenia 3-5 razy/tydzień)</option>
              <option value="1.725">Bardzo aktywny (ćwiczenia 6-7 razy/tydzień)</option>
              <option value="1.9">Ekstremalnie aktywny (ćwiczenia 2x dziennie)</option>
            </select>
          </div>
          
          <div>
            <label className="block text-gray-700">Cel</label>
            <select
              name="goal"
              value={formData.goal}
              onChange={handleChange}
            ...
            >
              ...
              <option value="weight-loss">Redukcja wagi</option>
              <option value="weight-gain">Zwiększenie masy</option>
            </select>
          </div>
        </div>
